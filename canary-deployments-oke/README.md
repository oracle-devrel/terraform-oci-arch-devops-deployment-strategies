...
Now, you'll want a local copy of this repo. You can make that with the commands:
    ...
    cd terraform-oci-arch-devops-deployment-strategies/canary-deployments-oke/
    ls
...
## Test the deployment.
Follow the link here to test the deployment - [procedure](https://github.com/oracle-devrel/oci-devops-examples/tree/main/oci-deployment-examples/oci-devops-deploy-with-canary-model-oke#lets-test)
